...
Permite visualizar y organizar la estructura completa del proyecto mediante una jerarquía de objetos.

Properties

Muestra las propiedades de cada objeto seleccionado, como posición, tamaño, color, materiales y comportamiento.

Script Editor

Editor integrado donde se desarrolla la lógica del juego utilizando el lenguaje Luau.
...
Programar las mecánicas del juego.
Probar el funcionamiento.
Corregir errores.
Publicar el proyecto en Roblox.
#Ventajas de Roblox Studio
Plataforma gratuita.
Fácil de aprender para principiantes.
Amplia comunidad de desarrolladores.
Desarrollo de juegos para múltiples dispositivos.
